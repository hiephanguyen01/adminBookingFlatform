import { Breadcrumb, Checkbox, Col, Divider, Form, Image, Input, Row } from "antd";
...
export const ModelInfo = ({ data, category }) => {
  if (!data) return null;
      ...
      >
        <Row gutter={32}>
          ...
          <Col span={12}>
            ...
            >
              <Input
                value={"Có kinh nghiệm chụp hình thời trang "}
                style={{ padding: "10px" }}
              />
            </Form.Item>
            <Form.Item
            ...
            >
              <Input
                value={"Á hậu 2 Miss Grand Vietnam 2022"}
                style={{ padding: "10px" }}
              />
            </Form.Item>
          </Col>
